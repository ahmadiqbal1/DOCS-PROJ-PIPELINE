...
from managementservice.http.requests_client import RequestsClient
...
class Configuration(object):
    ...
    @property
    def mlfm_siemens_local(self):
        return self._mlfm_siemens_local
    ...
    def __init__(
        ...
        # mlfm_siemens_local value
        self._mlfm_siemens_local = mlfm_siemens_local
    ...
    def clone_with(self, http_client_instance=None,
        ...
        mlfm_siemens_local = mlfm_siemens_local or self.mlfm_siemens_local
        ...
        return Configuration(
            ...
            environment=environment, mlfm_siemens_local=mlfm_siemens_local
        )
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: 'http://mlfm.siemens.local'
        }
    }
    ...
    def get_base_uri(self, server=Server.DEFAULT):
        ...
        """
        parameters = {
            "mlfm.siemens.local": {'value': self.mlfm_siemens_local, 'encode': False},
        }
